...
<tr>
    ...
    <tr>
        <td align="right" style="padding:5px;background-color:#F0F6FF;color:#000000"><a href="index.php?cmd=showblogs" title="<?php echo $msg_edit3; ?>"><b><?php echo $msg_edit3; ?></b></a> &raquo;</td>
    </tr>
    </table>
    <form method="POST" name="MyForm" action="index.php?cmd=edit&amp;id=<?php echo $_GET['id']; ?>">
    ...
    <tr>
        ...
        <tr>
          ...
          <td align="left"><a href="javascript:popWindow('http://www.maianscriptworld.co.uk/index.php?cmd=wysiwyg',10,10,700,550,1,1)" title="<?php echo $msg_add11; ?>"><b><?php echo $msg_add11; ?></b></a></td>
        </tr>
        </table>
        <?php
        }
        ...
        <td align="right" style="padding:3px;border-bottom:1px dashed #164677">&#8226; <b><?php echo ($SETTINGS->wysiwyg ? '<a href="#" onclick="delete_confirm(\''.$msg_javascript16.'\',\'index.php?cmd=edit&amp;id='.$_GET['id'].'&amp;enable=0\');return false" title="'.$msg_add10.'">'.$msg_add10.'</a>' : '<a href="#" onclick="delete_confirm(\''.$msg_javascript17.'\',\'index.php?cmd=edit&amp;id='.$_GET['id'].'&amp;enable=1\');return false" title="'.$msg_add9.'">'.$msg_add9.'</a>'); ?></b> &#8226;</td>
    </tr>
    <tr>
