<?php
   ...
   define('CAPTCHA_NUM_LINES', 40); // less lines makes it easier to read chars. 0 sets white bg
   define('CAPTCHA_CHAR_SHADOW', false);
   define('CAPTCHA_OWNER_TEXT', '');
   define('CAPTCHA_BACKGROUND_IMAGE', ''); //Use full path to image starting http://
   ...
   class PhpCaptcha {
      ...
      function PhpCaptcha(
         $aFonts = array('classes/fonts/arial.ttf','classes/fonts/verdana.ttf'), // array of TypeType fonts to use - specify full path
