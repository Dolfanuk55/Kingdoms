...
<input class="boxes" name="yname" type="text" value="<?php echo $this->YNAME_VALUE; ?>" /><?php echo $this->YNAME_ERROR; ?><br />
<label><?php echo $this->YOUR_EMAIL; ?>:<br /></label>
<input class="boxes" name="yemail" type="text" value="<?php echo $this->YEMAIL_VALUE; ?>" /><?php echo $this->YEMAIL_ERROR; ?><br />
<label><?php echo $this->FRIEND_NAME; ?>:<br /></label>
<input class="boxes" name="fname" type="text" value="<?php echo $this->FNAME_VALUE; ?>" /><?php echo $this->FNAME_ERROR; ?><br />
<label><?php echo $this->FRIEND_EMAIL; ?>:<br /></label>
<input class="boxes" name="femail" type="text" value="<?php echo $this->FEMAIL_VALUE; ?>" /><?php echo $this->FEMAIL_ERROR; ?><br />
